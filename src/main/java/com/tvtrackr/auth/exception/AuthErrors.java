...
public class AuthErrors extends BusinessErrors {
  ...
  public static final AuthErrors USER_NOT_FOUND = new AuthErrors("1002", "User not found", 400);
  public static final AuthErrors INVALID_CREDENTIALS =
      new AuthErrors("1003", "Invalid credentials", 401);
  public static final AuthErrors INVALID_TOKEN = new AuthErrors("1004", "Invalid token", 400);
  ...
  public static final AuthErrors EMAIL_SEND_FAILED =
      new AuthErrors("1006", "Failed to send email", 500);
  public static final AuthErrors TOO_MANY_REQUESTS =
      new AuthErrors("1007", "Too many requests. Please wait before sending more requests", 429);
